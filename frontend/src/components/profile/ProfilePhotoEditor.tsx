  ...
  const trigger =
    variant === 'avatar' ? (
      <button
        ...
        className={`group relative w-8 h-8 rounded-full bg-white/10 flex items-center justify-center overflow-hidden ring-1 ring-white/15 hover:ring-[var(--bt-accent-2)] transition ${className}`}
