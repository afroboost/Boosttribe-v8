...
export const ScreenShareView: React.FC<ScreenShareViewProps> = ({ stream, isLocal, onStop, hostName }) => {
  ...
  return (
    <div className="rounded-2xl overflow-hidden border border-[#8A2EFF]/30 bg-[rgba(20,20,25,0.95)]" data-testid="screen-share-view">
      <div className="flex items-center justify-between px-4 py-2 border-b border-white/10">
        <span className="flex items-center gap-2 text-white/80 text-sm min-w-0">
          <MonitorUp className="w-4 h-4 text-[#8A2EFF]" />
