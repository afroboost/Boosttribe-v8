  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6" style={{ background: '#0a0a0f' }}>
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-1/4 -left-1/4 w-1/2 h-1/2 rounded-full opacity-20 blur-3xl" style={{ background: 'radial-gradient(circle, var(--bt-accent) 0%, transparent 70%)' }} />
        <div className="absolute -bottom-1/4 -right-1/4 w-1/2 h-1/2 rounded-full opacity-15 blur-3xl" style={{ background: 'radial-gradient(circle, var(--bt-accent-2) 0%, transparent 70%)' }} />
      </div>
      ...
      <div className="relative z-10 w-full max-w-md rounded-2xl border border-white/10 bg-[rgba(20,20,25,0.9)] backdrop-blur-xl p-8 text-center">
        {/* Avatar */}
        <div className="w-20 h-20 mx-auto mb-5 rounded-full overflow-hidden flex items-center justify-center ring-2 ring-[rgb(var(--bt-accent-rgb)/0.4)]"
        ...
        {refused ? (
          ...
          <>
            <div className="flex items-center justify-center gap-2 mb-3">
              <span className="flex items-center gap-1.5 text-[var(--bt-accent)] text-xs px-2.5 py-1 rounded-full bg-[rgb(var(--bt-accent-rgb)/0.15)] border border-[rgb(var(--bt-accent-rgb)/0.3)]">
            ...
            <div className="flex items-center justify-center gap-2 text-[var(--bt-accent)]">
